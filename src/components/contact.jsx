                  ...
                  <div className="col-md-5">
                    <div className="colorlib-feature colorlib-feature-sm animate-box" data-animate-effect="fadeInLeft">
                      ...
                      <div className="colorlib-text">
                        <p><a href="#"><span className="__cf_email__" data-cfemail="96fff8f0f9d6f2f9fbf7fff8b8f5f9fb">[email&nbsp;protected]</span></a></p>
                      </div>
                    </div>
                    <div className="colorlib-feature colorlib-feature-sm animate-box" data-animate-effect="fadeInLeft">
                      <div className="colorlib-icon">
                      ...
                      <div className="colorlib-text">
                        <p>9502 Erickson Drive, Suite 206, Vancouver BC V3J7B5</p>
                      </div>
                    </div>
                    <div className="colorlib-feature colorlib-feature-sm animate-box" data-animate-effect="fadeInLeft">
                      <div className="colorlib-icon">
                      ...
                      <div className="colorlib-text">
                        <p><a href="tel://">+1 672 999 7997</a></p>
                      </div>
                    </div>
                  </div>
